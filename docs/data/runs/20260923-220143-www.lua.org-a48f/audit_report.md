...
_Audited 2026-09-23T16:32:53Z · 15 pages sampled in 20.0s_

**19 findings** — 0 critical · 3 high · 9 medium · 7 low
...
- **F-015 · No llms.txt (optional, unproven -- informational only)** (low, quick effort) — Optional. Prioritise sitemap.xml, crawler access and visible on-page facts first -- all three are far better evidenced. Add llms.txt only if it is cheap and you accept it may do nothing.
...
- **F-012 · Homepage does not say who Lua is for or what to do next in its body text** (medium, unknown effort) — Add an H1 and a one-sentence description (e.g. what Lua is, what it is used for) plus a prominent Get started / Download link.
...
- **F-013 · Most pages have no meta description** (low, moderate effort) — Write a specific description (roughly 120-160 characters) for each substantive page.
- **F-016 · Pages open without a summary paragraph** (low, moderate effort) — Open each substantive page with a 40-120 word summary that directly answers the question the page exists to answer.
- **F-017 · Independent sources corroborate the brand, but the site does not link to them** (low, unknown effort) — Add Organization/SoftwareApplication JSON-LD on the homepage with a stable @id and sameAs pointing to Wikidata Q207316 and the Wikipedia article.
...
### F-012 · Homepage does not say who Lua is for or what to do next in its body text

- **Code:** `HOMEPAGE_DOES_NOT_SAY_WHO`  ·  **Severity:** medium  ·  **Confidence:** 90%  ·  **Category:** engagement  ·  **Evidence strength:** measured
- **What we found:** Homepage text_sample (18 words): 'The Programming Language Lua about news get started download documentation community site map portugu?s designed and developed at'. Q1 what: only the title/logo name it a programming language, no descriptive sentence. Q2 audience: not stated. Q3 next: nav includes 'get started' and 'download' but nothing is emphasised.
- **Why it matters:** A first-time visitor or extractor gets a name and a nav bar but no one-sentence description or audience.
- **Do this (medium, unknown effort):** Add an H1 and a one-sentence description (e.g. what Lua is, what it is used for) plus a prominent Get started / Download link.

### F-013 · Most pages have no meta description
...
### F-015 · No llms.txt (optional, unproven -- informational only)
...
### F-016 · Pages open without a summary paragraph
...
### F-017 · Independent sources corroborate the brand, but the site does not link to them

- **Code:** `INDEPENDENT_SOURCES_CORROBORATE_THE_BRAND`  ·  **Severity:** low  ·  **Confidence:** 70%  ·  **Category:** discoverability  ·  **Evidence strength:** correlational
- **What we found:** Brief search (2 queries) found independent coverage: Wikipedia (Lua (programming language)), Wikidata Q207316 (inception 1993), CACM 'A Look at the Design of Lua', ScienceDirect. Homepage JSON-LD types: none; no sameAs links.
- **Why it matters:** Off-site footprint is healthy, but with no machine-readable identity on lua.org, engines must infer that these sources describe this site. Structured data supports entity identity; it is not claimed to raise citations.
- **Do this (low, unknown effort):** Add Organization/SoftwareApplication JSON-LD on the homepage with a stable @id and sameAs pointing to Wikidata Q207316 and the Wikipedia article.
